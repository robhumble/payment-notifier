...
public abstract class ContactAccessor {
    ...
    public static ContactAccessor getInstance() {
        if (sInstance == null) {
            ...
            if (sdkVersion < Build.VERSION_CODES.ECLAIR) {
                className = "com.HumBotSoft.payNotif.ContactAccessorSdk3_4";
            } else {
               className = "com.HumBotSoft.payNotif.ContactAccessorSdk5";
     ...
     */
    public abstract TargetContact loadContact(ContentResolver contentResolver, Uri contactUri);
}